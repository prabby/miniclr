...
namespace Ws.SvcUtilCodeGen
{
    ...
    internal class ClientProxyGenerator
    {
        ...
        private CodeConstructor BuildFirstConstructor(bool hasEvents, ClientProxy clientProxy)
        {
            ...
            // Generated Code: Init();
            constructor.Statements.Add(
                new CodeMethodInvokeExpression(null, "Init")
            );

            return constructor;
        }

        private CodeConstructor BuildSecondConstructor(bool hasEvents, ClientProxy clientProxy)
        {
            CodeConstructor constructor = new CodeConstructor();
            constructor.Parameters.Add(new CodeParameterDeclarationExpression(typeof(int), "port"));
            constructor.BaseConstructorArgs.Add(new CodeVariableReferenceExpression("port"));
            constructor.Name = clientProxy.Name + "ClientProxy";
            constructor.Attributes = MemberAttributes.Public;
        ...
        private CodeMemberMethod BuildProxyCallbackMethod(ServiceOp serviceOp, ClientProxy clientProxy)
        {
            ...
            codeMethod.ReturnType = new CodeTypeReference("Byte", 1);
        ...
        private CodeMemberMethod BuildClientProxyMethod(ServiceOp serviceOp, IList<Message> messages, MessageEncodingType encodingType)
        {
            ...
            // Generated Code: header = new WsWsaHeader(action, null, ServiceEndpoint, null, EndpointAddress, null);
            codeMethod.Statements.Add(
                new CodeAssignStatement(
                    ...
                    new CodeObjectCreateExpression(
                        ...
                        new CodeExpression[] {
                            ...
                            new CodeVariableReferenceExpression("ServiceEndpoint"),
                            new CodePrimitiveExpression(null),
                            new CodeVariableReferenceExpression("EndpointAddress"),
                            new CodePrimitiveExpression(null),
                        }
        ...
        internal void GenerateCode(string filename, ClientProxies clientProxies)
        {
            ...
            foreach (ClientProxy clientProxy in clientProxies)
            {
                ...
                codeType.Members.Add(BuildSecondConstructor(hasEvents, clientProxy));

                // Build Init method
                codeType.Members.Add(BuildInitMethod(hasEvents, clientProxy));
