...
namespace Ws.SvcUtilCodeGen
{
    ...
    internal class HostedServiceGenerator
    {
                ...
                new CodeVariableDeclarationStatement(
                    ...
                    new CodeObjectCreateExpression(
                        ...
                        new CodeExpression[] {
                            ...
                            new CodeFieldReferenceExpression(new CodeVariableReferenceExpression("header"), "MessageID"),
                            new CodeFieldReferenceExpression(new CodeVariableReferenceExpression("WsWellKnownUri"), "WsaAnonymousUri"),
        ...
        private CodeMemberMethod BuildEventSource(ServiceOp serviceOp, IList<Message> messages)
        {
            ...
            // If the event mmessage body is empty skip serialization code
            if (reqTypeName != "void")
            {
                codeMethod.Statements.Add(new CodeSnippetStatement(""));
                ...
                // eventDcs = new eventTypeNameDataContractSerializer("elementTypeName", ServiceNamespace.Namespace);
                codeMethod.Statements.Add(
                    new CodeAssignStatement(
            ...
            codeMethod.Statements.Add(
                new CodeMethodInvokeExpression(
                    ...
                    new CodeExpression[] {
                        ...
                        new CodeTypeReferenceExpression("header"),
