...
namespace Microsoft.SPOT.Wireless.IEEE_802_15_4
{
    ...
    public class Leds :IDisposable
    {
        ...
        public Leds()
        {
            ledRed = new Led(CC2420Pins.GPIO_PORT_LED_RED);
            ledGreen = new Led(CC2420Pins.GPIO_PORT_LED_GREEN);
            ledBlue = new Led(CC2420Pins.GPIO_PORT_LED_BLUE);
        }
