...
namespace Dpws.Client.Discovery
{
    ...
    class DpwsDiscoClientProcessor
    {
        ...
        /// </summary>
        public DpwsDiscoClientProcessor()
        {
        }
        ...
        public DpwsServiceDescriptions ProcessProbeMatch(byte[] probeResponse, string messageID, IPEndPoint remoteEP, WsMessageCheck messageCheck)
        {
        ...
        /// </returns>
        /// <exception cref="XmlException">If required tags are missing or invalid namespaces are detected.</exception>
        public DpwsServiceDescription ProcessResolveMatch(byte[] resolveResponse, string messageID, IPEndPoint remoteEP, WsMessageCheck messageCheck)
        {
        ...
        internal DpwsMetadata ProcessGetResponse(byte[] soapResponse, string messageID)
        {
            ...
            try
            {
                reader = WsSoapMessageParser.ParseSoapMessage(soapResponse, out header);
            }
            catch
            {
                return null;
            ...
            try
            {
                ...
                int depth = reader.Depth;
#endif
                DpwsMetadata metaData = new DpwsMetadata(reader);
#if DEBUG
                Microsoft.SPOT.Debug.Assert(XmlReaderHelper.HasReadCompleteNode(depth, reader));
#endif
                return metaData;
