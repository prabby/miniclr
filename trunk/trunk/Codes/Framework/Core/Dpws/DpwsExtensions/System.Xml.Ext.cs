...
namespace System.Ext.Xml
{
    ...
    // Summary:
    //     Represents a collection of Elements used during the writing process to keep track of
    //     the tag hirearchy. The collection is used like a stack i.e. last top. When a new element
    //     is created and element item representing the element is added to the top of the stack.
    //     See ElementInfo object for the properties of Element objects
    internal class ElementStack
    {
        // Fields
        ArrayList _ElementList = new ArrayList();
        ...
        //     index is less than zero.-or- index is equal to or greater than ElementList.Count.
        public ElementInfo this[int index]
        {
            get
            {
                if (index < 0 || index > _ElementList.Count)
                    throw new ArgumentOutOfRangeException("index", "must be between 0 and ElementList.Count");
                return (ElementInfo)_ElementList[index];
            }
    ...
    public class XmlWriter : IDisposable
    {
        ...
        // Element stack
        ElementStack _ElementStack = new ElementStack();
        ...
        public void WriteAttributeString(string prefix, string localName, string ns, string value)
        {
            ...
            if (prefix == "xmlns" || (prefix == null && ns == "http://www.w3.org/2000/xmlns/"))
            {
                ...
                _ElementStack[0].State = _WriteState = WriteState.Element;
                return;
            }
        ...
        public void WriteElementString(string prefix, string localName, string ns, string value)
        {
            ...
            // Set WriterState
            _ElementStack[0].State = _WriteState = WriteState.Content;
        ...
        public void WriteStartAttribute(string prefix, string localName, string ns)
        {
            ...
            if (prefix == "xmlns" || ns == "http://www.w3.org/2000/xmlns/")
            {
                ...
                _ElementStack[0].State = _WriteState = WriteState.Attribute;
                return;
            }
