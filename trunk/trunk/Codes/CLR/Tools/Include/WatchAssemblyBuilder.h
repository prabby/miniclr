...
namespace WatchAssemblyBuilder
{
    ...
    class Linker
    {
        ...
        MetaData::Reparser::Assembly*        m_rpr;
        ...
        bool GenerateSignature          ( MetaData::Reparser::TypeSignature     * sig                                                               );
        bool GenerateSignature          ( MetaData::CustomAttribute             & ca                                                                );
        bool GenerateSignature          ( MetaData::Reparser::Attribute         * ca                                                                );
        ...
        bool GenerateSignatureToken     (                                              MetaData::Reparser::BaseToken* ptr                           );        
        ...
        bool AllocSignatureForField     ( MetaData::Reparser::TypeSignature     * sig, CLR_SIG&                       idx                           );
        bool AllocSignatureForMethod    ( MetaData::MethodSignature             * sig, CLR_SIG&                       idx                           );
        bool AllocSignatureForMethod    ( MetaData::Reparser::MethodSignature   & sig, CLR_SIG&                       idx                           );
        bool AllocSignatureForAttribute ( MetaData::CustomAttribute             & ca , CLR_SIG&                       idx                           );
        bool AllocSignatureForAttribute ( MetaData::Reparser::Attribute         * ca , CLR_SIG&                       idx                           );
        bool AllocSignatureForTypeSpec  ( MetaData::TypeSignature               * sig, CLR_SIG&                       idx                           );
        bool AllocSignatureForTypeSpec  ( MetaData::Reparser::TypeSignature     * sig, CLR_SIG&                       idx                           );
        bool AllocSignatureForLocalVar  ( MetaData::LocalVarSignature           & sig, CLR_SIG&                       idx                           );
        bool AllocSignatureForLocalVar  ( MetaData::Reparser::LocalVarSignature & sig, CLR_SIG&                       idx                           );
        bool AllocSignatureForInterfaces( MetaData::mdInterfaceImplList         & sig, CLR_SIG&                       idx                           );
        bool AllocSignatureForInterfaces( MetaData::Reparser::BaseTokenPtrList  & lst, CLR_SIG&                       idx                           );

        HRESULT ValidateTypeRefOrDef( mdToken                        tk, bool fAsInterface );
        CLR_IDX EncodeTypeRefOrDef  ( mdToken                        tk                    );
        CLR_IDX EncodeTypeRefOrDef  ( MetaData::Reparser::BaseToken* ptr                   );
        CLR_IDX EncodeToken         ( mdToken                        tk                    );
        CLR_IDX EncodeToken         ( MetaData::Reparser::BaseToken* ptr                   );

        HRESULT ResolveTypeRef( MetaData::TypeRef&           tr, MetaData::mdTypeRefList&              order, MetaData::mdTokenSet& resolved );
        HRESULT ResolveTypeRef( MetaData::Reparser::TypeRef& tr, MetaData::Reparser::BaseTokenPtrList& order, MetaData::mdTokenSet& resolved );
        HRESULT ResolveTypeDef( MetaData::TypeDef&           td, MetaData::mdTypeRefList&              order, MetaData::mdTokenSet& resolved );
        HRESULT ResolveTypeDef( MetaData::Reparser::TypeDef& td, MetaData::Reparser::BaseTokenPtrList& order, MetaData::mdTokenSet& resolved );
        ...
        HRESULT ReprocessAssemblyRef       (                                                                                                           );
        HRESULT ReprocessTypeRef           (                                                                                                           );
        HRESULT ReprocessFieldRef          (                                                                                                           );
        HRESULT ReprocessMethodRef         (                                                                                                           );
        HRESULT ReprocessTypeDef           ( MetaData::Reparser::BaseTokenPtrList& order                                                               );
        HRESULT ReprocessTypeDef           ( MetaData::Reparser::TypeDef*          td                                                                  );
        HRESULT ReprocessTypeDef_ByteCode  ( MetaData::Reparser::TypeDef*          td                                                                  );
        HRESULT ReprocessFieldDef          ( MetaData::Reparser::TypeDef*          td   , CLR_RECORD_TYPEDEF* tdDst, MetaData::Reparser::FieldDef*  fd );
        HRESULT ReprocessMethodDef         ( MetaData::Reparser::TypeDef*          td   , CLR_RECORD_TYPEDEF* tdDst, MetaData::Reparser::MethodDef* md );
        HRESULT ReprocessMethodDef_ByteCode( MetaData::Reparser::TypeDef*          td   , CLR_RECORD_TYPEDEF* tdDst, MetaData::Reparser::MethodDef* md );
        HRESULT ReprocessTypeSpec          (                                                                                                           );
        HRESULT ReprocessAttribute         (                                                                                                           );
        HRESULT ReprocessResource          (                                                                                                           );
        HRESULT ReprocessUserString        (                                                                                                           );
    ...
    public:
        ...
        HRESULT Reprocess( MetaData::Reparser::Assembly& rpr );
