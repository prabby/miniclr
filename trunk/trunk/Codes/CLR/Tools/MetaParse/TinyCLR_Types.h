...
{
	CLR_RECORD_ASSEMBLY							   m_header;

	//
	//MetaData tables
	//
	CLR_RECORD_ASSEMBLYREF*						 m_pAssemblyRefPtr;
	CLR_RECORD_TYPEREF*								 m_pTypeRefPtr;
	CLR_RECORD_FIELDREF*							 m_pFieldRefPtr;	
	CLR_RECORD_METHODREF*							 m_pMethodRefPtr;
	CLR_RECORD_TYPEDEF*								 m_pTypeDefPtr;	
	CLR_RECORD_FIELDDEF*					     m_pFieldDefPtr;							
	CLR_RECORD_METHODDEF*							 m_pMethodDefPtr;			
	CLR_RECORD_ATTRIBUTE*							 m_pAttributePtr;
	CLR_RECORD_TYPESPEC*							 m_pTypeSpecPtr;
	CLR_RECORD_RESOURCE*				       m_pResourcePtr;
	CLR_RECORD_RESOURCE_FILE*					 m_pResourceFilePtr;

	PBYTE															 m_pResourcesDataPtr;

	PBYTE															 m_pStringsPtr;
	PBYTE															 m_pSignaturesPtr;
	PBYTE															 m_pByteCodePtr;	
