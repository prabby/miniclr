...
struct Library_spot_hardware_native_Microsoft_SPOT_Hardware_SPI
{
    ...
    TINYCLR_NATIVE_DECLARE(InternalWriteRead___VOID__SZARRAY_U2__I4__SZARRAY_U2__I4);
    TINYCLR_NATIVE_DECLARE(InternalWriteRead___VOID__SZARRAY_U1__I4__SZARRAY_U1__I4);
