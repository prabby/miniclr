...
namespace Microsoft.SPOT.Input
{
    ...
    */
    ...
    public class ProcessInputEventArgs : NotifyInputEventArgs
    {
        ...
        {
            StagingAreaInputItem item = new StagingAreaInputItem(false, input, promote);
            
            InputManager.CurrentInputManager._stagingArea.Push(item);
        ...
        {
            InputManager.CurrentInputManager._stagingArea.Push(input);
        ...
        {
            Stack stagingArea = InputManager.CurrentInputManager._stagingArea;
