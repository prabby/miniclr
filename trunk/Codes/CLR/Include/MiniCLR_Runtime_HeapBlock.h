...
#ifndef _MINICLR_RUNTIME_HEAPBLOCK_H_
#define _MINICLR_RUNTIME_HEAPBLOCK_H_

#include "MiniCLR_Types.h"
////////////////////////////////////////////////////////////

typedef struct _CLR_RT_HeapBlock
{
    //--//
#define  CLR_RT_HB_FLAGS_ALIVE										0x01
#define  CLR_RT_HB_FLAGS_KEEP_ALIVE								0x02
#define  CLR_RT_HB_FLAGS_EVENT										0x04
#define  CLR_RT_HB_FLAGS_PINNED										0x08
#define  CLR_RT_HB_FLAGS_BOXED										0x10
#define  CLR_RT_HB_FLAGS_UNUSED20									0x20
...
#define  CLR_RT_HB_FLAGS_SIGNALED									0x40
#define  CLR_RT_HB_FLAGS_SIGNAL_AUTO_RESET				0x80

#define  CLR_RT_HB_FLAGS_UNMOVABLE								(CLR_RT_HB_FLAGS_PINNED | CLR_RT_HB_FLAGS_EVENT)

    //
    // These are special flags used to control allocation.
    //
#define  CLR_RT_HB_FLAGS_INITIALIZE_TO_ZERO				0x00100
#define  CLR_RT_HB_FLAGS_NOGC_ONFAILURE						0x00200
#define  CLR_RT_HB_FLAGS_SPECIAL_GC_ALLOCATION		0x00400
#define  CLR_RT_HB_FLAGS_COMPACT_ONFAILURE				0x00800

#define  CLR_RT_HB_FLAGS_NOGC_ONFAILED_ALLOCATION (CLR_RT_HB_FLAGS_SPECIAL_GC_ALLOCATION | CLR_RT_HB_FLAGS_NOGC_ONFAILURE)
#define  CLR_RT_HB_FLAGS_MAXSIZE									0x0000FFFF

#define  CLR_RT_HB_FLAGS_OBJECT_FIELDS_OFFSET			1
...
struct CLR_RT_HeapBlock_Node : public CLR_RT_HeapBlock
{
    ...
    void Unlink()
    {
        ...
        if(prev && next)
        {
            prev->m_data.nodeLink.nextBlock = next; m_data.nodeLink.prevBlock = NULL;
            next->m_data.nodeLink.prevBlock = prev; m_data.nodeLink.nextBlock = NULL;
        }
    }
...
private:
    ...
    CLR_RT_HeapBlock_MemoryStream::Buffer* NewBuffer();
};
...
#endif // _MINICLR_RUNTIME_HEAPBLOCK_H_
