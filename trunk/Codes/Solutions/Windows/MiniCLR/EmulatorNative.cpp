...
Settings::Settings()
{
    ...
    m_emuSettings.PerformGarbageCollection = true;
...
BOOL EmulatorStart(LPCWSTR szCmdLineArgs)
{
	Settings* st;
	...
	st->SetCommandLineArguments(szCmdLineArgs);

	ClrStartup(st->m_emuSettings);
