...
RTP_BOOL enc28j60_setup_device(PIFACE pi)
{
    ...
    do
    {
        ...
        if(50 < nLoopCnt++) return RTP_FALSE;
    ...
    enc28j60_read_spi(SpiConf, ENC28J60_SPI_READ_CONTROL_REGISTER_OPCODE, ENC28J60_EIE, &byteData, 1, 0);
    byteData |= ((1 << ENC28J60_EIE_INTIE_BIT) | (1 << ENC28J60_EIE_PKTIE_BIT) | (1 << ENC28J60_EIE_TXIE_BIT) |(1 << ENC28J60_EIE_TXERIE_BIT));
    enc28j60_write_spi(SpiConf, ENC28J60_SPI_WRITE_CONTROL_REGISTER_OPCODE, ENC28J60_EIE, &byteData, 1);
    
    /* enable auto- increment */
    enc28j60_read_spi(SpiConf, ENC28J60_SPI_READ_CONTROL_REGISTER_OPCODE, ENC28J60_ECON2, &byteData, 1, 0);
    byteData |= (1 << ENC28J60_ECON2_AUTOINC_BIT);
    enc28j60_write_spi(SpiConf, ENC28J60_SPI_WRITE_CONTROL_REGISTER_OPCODE, ENC28J60_ECON2, &byteData, 1);
...
{
    NATIVE_PROFILE_HAL_DRIVERS_ETHERNET();
    RTP_UINT8 commandWithData;
    
    /* Combine the command and the data */
    commandWithData = (ENC28J60_SPI_SYSTEM_COMMAND_SOFT_RESET_OPCODE << 5) | 
                        ENC28J60_SPI_SYSTEM_COMMAND_SOFT_RESET_ARGUMENT;
    CPU_SPI_nWrite8_nRead8 (*spiConf, (RTP_PFUINT8)&commandWithData, 1, 0, 0, 0);
    
    /* Errata : After reset wait for 1 ms */
